"""
Django settings for broken_limit_45449 project.
...
ROOT_URLCONF = 'broken_limit_45449.urls'
...
WSGI_APPLICATION = 'broken_limit_45449.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_limit_45449 API",
    "DESCRIPTION": "API documentation for broken_limit_45449 App",
    "VERSION": "v1",
}
